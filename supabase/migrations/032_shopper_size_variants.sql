-- Shopper: 2 prodotti base con varianti misura (JSONB).
...
values
  (
    ...
    'Cancelleria',
    'Shopper in Plastica',
    'Sacchetti e shopper compostabili e in plastica per la spesa, ortofrutta e attività commerciali. Materiale Mater-Bi compostabile, colore bianco. Scegli la misura (Mini, Midi o Maxi); ogni confezione è una scatola da 500 pezzi. Prezzo su preventivo.',
    100,
    '[
  ...
  (
    ...
    'Cancelleria',
    'Shopper in Carta',
    'Buste e shopper in carta ideali per negozi, boutique e confezioni regalo. Carta kraft bianca con maniglie a cordino. Scegli la misura; la confezione varia in base al formato. Prezzo su preventivo.',
    100,
    '[
