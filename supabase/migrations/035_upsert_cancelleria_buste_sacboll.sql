-- Cancelleria → Buste + articolo Sacboll Blasetti (10 formati)
-- Funzione idempotente: upsert_cancelleria_buste_sacboll()
-- Eseguibile anche da: scripts/seed-sacboll-buste.sql
...
begin
  ...
  -- Rimuove seed legacy Avana/Bianco separati
...
-- Esecuzione immediata (seed)
select public.upsert_cancelleria_buste_sacboll();
