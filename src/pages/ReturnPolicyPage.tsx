...
const TOC: TocItem[] = [
  ...
  { id: 'rimborso', label: '5. Tempi e modalitÃ  di rimborso' },
...
/** Pagina dedicata Â«Norme sui resiÂ» per Google Merchant Center e clienti. */
    ...
    <main className="min-h-[60vh] bg-gradient-to-b from-brand-50/50 to-white">
      <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <section id="come-esercitare" className="mt-4 rounded-2xl border border-slate-200 bg-white p-5">
          ...
          <p className="mt-2 text-sm leading-relaxed text-slate-700">
            Ã possibile utilizzare il modulo tipo di recesso previsto dall&apos;Allegato I, parte B, del
            Codice del Consumo, senza che ciÃ² sia obbligatorio.
          </p>
        </section>
        ...
        <section id="rimborso" className="mt-4 rounded-2xl border border-slate-200 bg-white p-5">
          <h3 className="text-lg font-semibold text-slate-900">5. Tempi e modalitÃ  di rimborso</h3>
          <p className="mt-2 text-sm leading-relaxed text-slate-700">
            Il Venditore rimborsa i pagamenti ricevuti per i beni restituiti, compresi i costi di consegna
            standard (esclusi costi aggiuntivi per modalitÃ  di consegna diverse da quella meno costosa
            offerta), senza indebito ritardo e comunque entro <strong>14 giorni</strong> dal giorno in cui
            Ã¨ informato della decisione di recedere.
          </p>
          <p className="mt-2 text-sm leading-relaxed text-slate-700">
        ...
        <section id="garanzia" className="mt-4 rounded-2xl border border-slate-200 bg-white p-5">
          ...
          <p className="mt-2 text-sm leading-relaxed text-slate-700">
            In caso di prodotto difettoso o non conforme, il Cliente consumatore puÃ² avvalersi della{' '}
            <strong>garanzia legale di conformitÃ </strong> (2 anni dalla consegna), come descritto nei{' '}
            <Link
            ...
            del problema: in questi casi le modalitÃ  di reso/rimborso o sostituzione seguono la normativa
