        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #e2e8f0;">
          ...
          <tr>
            <td style="padding:20px 28px;background:#0f172a;color:#cbd5e1;font-size:12px;line-height:1.5;text-align:center;">
              ...
              <a href="${EMAIL_SITE_ORIGIN}" style="color:#fdba74;text-decoration:none;">${EMAIL_SITE_ORIGIN.replace('https://', '')}</a>
...
export function buildOrderConfirmationEmail(
  ...
  const html = layout(
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-top:16px;">
      <tr>
        <td style="padding:4px 0;font-size:14px;color:#64748b;">Imponibile</td>
        <td style="padding:4px 0;font-size:14px;color:#0f172a;text-align:right;">${formatEuroIt(input.taxableTotal)}</td>
      </tr>
      <tr>
        <td style="padding:4px 0;font-size:14px;color:#64748b;">IVA</td>
        <td style="padding:4px 0;font-size:14px;color:#0f172a;text-align:right;">${formatEuroIt(input.vatAmount)}</td>
      </tr>
      <tr>
        <td style="padding:4px 0;font-size:14px;color:#64748b;">Spedizione</td>
        <td style="padding:4px 0;font-size:14px;color:#0f172a;text-align:right;">${formatEuroIt(input.shippingFee)}</td>
      </tr>
      <tr>
        <td style="padding:10px 0 0;font-size:16px;font-weight:700;color:#0f172a;">Totale</td>
        <td style="padding:10px 0 0;font-size:16px;font-weight:700;color:#0f172a;text-align:right;">${formatEuroIt(input.totalWithVat)}</td>
      </tr>
    </table>
    ${
...
export function buildShippingEmail(input: ShippingEmailInput): { subject: string; html: string } {
